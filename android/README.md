...
- The emulator API base URL defaults to `http://10.0.2.2:4000/`. Override it with the `LOVER_API_BASE_URL` Gradle property or environment variable. Release builds disable cleartext traffic, so use an HTTPS production URL.
